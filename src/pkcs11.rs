...
pub(crate) enum EcCurve {
	/// ed25519
	///
	/// Note that this has not been tested since softhsm does not support it, which in turn is because openssl (as of v1.1.1c) does not support it
	/// for key generation.
	Ed25519,
